<%-- 
    Document   : login
    Created on : May 31, 2023, 6:40:24 PM
    Author     : Min
--%>
            ...
            <div class="logreg-box">
                <div class="form-box login">
                    <form action="MainController" method="POST">
                        ...
                        <div class="g-recaptcha" data-sitekey="6LdYcQEnAAAAAI59Ugf5lEbJp3gtX9I1B5hUqBZs"></div>
                        <div id="error"></div>
                        
                        <button type="submit" name="action" value="Login" class="btn">Sign In</button>

                        <div class="login-register">
                            <p>Don't have an account? <a href="MainController?action=CreatePage" class="register-link">Sign up</a></p>
                        </div>
                    </form>
                </div>
